...
public enum Position {
  ...
  public void addIntSlider(String callName, String dispName, int min, int max, int value) {
    controllers.put(callName, new IntSlider(dispName, min, max, value, new Point(this.menuCoordinates)));
  }
