...
void setup() {
  ...
  aiController = new PopAIController(nodeManager, "Team2", 100);
  float moveSpeed = 0.94;
  int numNeutrals = 600;
  ...
  nodeManager.addNode(new PopNodeSVG(nodeManager, 0.5, new Point(600, 300), 10, 200, "Team2", color(255), tempMinion2));
