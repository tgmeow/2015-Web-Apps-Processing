...
public class TangHorse extends TangShape {
   ...
   */
  public TangHorse(float x, float y, int aShakeWeight, int unit, float scale, float xDiff, float yDiff, boolean alwaysShake, float rotationDiff, boolean flashAOn, color aColor) {
    this.x = x;
    this.y = y;
  ...
  public void drawThisTangram() {
    ...
    isHovered = drawTangramHorse(x, y, shakeWeight, unit, scale, alwaysShake, rotation, flashAOn, horseColor);
  }
}
/**
 ...
 * 
 */
public boolean drawTangramHorse(float x, float y, int shakeWeight, int unit, float scale, boolean shakeAlwaysOn, float rotation, boolean flashAOn, color aColor) {
  ...
  isHovered = triM1.doHoverShake(shakeWeight, flashAOn, aColor) || isHovered;
  triM1.drawShape();  //draw this tangram piece
  isHovered = square.doHoverShake(shakeWeight, flashAOn, aColor) || isHovered;
  square.drawShape();
  isHovered = triS1.doHoverShake(shakeWeight, flashAOn, aColor)  || isHovered;
  triS1.drawShape();
  isHovered = triL1.doHoverShake(shakeWeight, flashAOn, aColor) || isHovered;
  triL1.drawShape();
  isHovered = triL2.doHoverShake(shakeWeight, flashAOn, aColor) || isHovered;
  triL2.drawShape();
  isHovered = triS2.doHoverShake(shakeWeight, flashAOn, aColor) || isHovered;
  triS2.drawShape();
  isHovered = parallelogram.doHoverShake(shakeWeight, flashAOn, aColor) || isHovered;
